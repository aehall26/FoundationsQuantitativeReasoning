...
```{r}
 eigen1$vector[,1]/sum(eigen1$vector[,1])
```

This means that ~94% of the population is held in stage one- "YOY" young of year trout, and then the age distrubution decreases as the age classes get older. 
